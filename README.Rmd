...
-   `helper` functions are designed to help you understand more details
    ...
    -   `helper_dets` helps you find the codes for the determinands you
        are interested in
...
-   `fetch` functions are designed to pull data via the ddspwqa API
    ...
    -   `fetch_sample_res` pulls in the sample results for the sample
        points you provide
...
-   More `helper` functions to help understanding of arguments that can
